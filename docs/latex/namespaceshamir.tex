\doxysection{shamir Namespace Reference}
\label{namespaceshamir}\index{shamir@{shamir}}
\doxysubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
def \textbf{ get\+\_\+polynomial\+\_\+degree} (str polynomial)
\item 
def \textbf{ create\+\_\+digest} (bytes randomness, bytes shared\+\_\+secret, digest\+\_\+length=4)
\item 
def \textbf{ lagrange\+\_\+interpolation} (list x, list y, list at\+\_\+points, str primitive\+\_\+poly)
\item 
def \textbf{ share\+\_\+generation} (int secret, int num\+\_\+shares, int threshold, str primitive\+\_\+poly, digest\+\_\+length=4)
\item 
def \textbf{ secret\+\_\+reconstruction} (list x, list y, str primitive\+\_\+poly, digest\+\_\+length=4)
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\begin{DoxyVerb}Module implementing the functions that perform Shamir secret sharing on numerical inputs/outputs\end{DoxyVerb}
 

\doxysubsection{Function Documentation}
\mbox{\label{namespaceshamir_a24b895bca5c6f757e74294a3a67cff32}} 
\index{shamir@{shamir}!create\_digest@{create\_digest}}
\index{create\_digest@{create\_digest}!shamir@{shamir}}
\doxysubsubsection{create\_digest()}
...
\begin{DoxyVerb}Digest function according to SLIP39. Digest length set to 4 by default as per SLIP39\end{DoxyVerb}
 \mbox{\label{namespaceshamir_a263d4e85b75242cd1ed3d931c6dc6e9b}} 
...
\doxysubsubsection{get\_polynomial\_degree()}
...
\begin{DoxyVerb}Gets degree of a polynomial in string form with the galois package\end{DoxyVerb}
 \mbox{\label{namespaceshamir_a46b5edd435fe67eb9d2757b7a1d7b9e4}} 
...
\doxysubsubsection{lagrange\_interpolation()}
...
\begin{DoxyVerb}Performs Lagrange interpolation on a Galois field GF(2^d), where d is the degree of primitive_poly.
...
\end{DoxyVerb}
 \mbox{\label{namespaceshamir_a563499ba0bed3c0210657a0dbbebbd85}} 
...
\doxysubsubsection{secret\_reconstruction()}
...
\begin{DoxyVerb}Reconstruct secret from the shares, and check for consistency with the encoded digest.
...
\begin{DoxyVerb}Turns an element of a Galois Field (in integer representation) into many, via Shamir secret sharing
