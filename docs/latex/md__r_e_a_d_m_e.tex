\hypertarget{md__r_e_a_d_m_e_autotoc_md4}{}\doxysection{Table of contents}\label{md__r_e_a_d_m_e_autotoc_md4}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md9}{}\doxysubsection{2. Reconstruction Phase\+:}\label{md__r_e_a_d_m_e_autotoc_md9}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md10}{}\doxysection{Generating shares and reconstruction of the secret}\label{md__r_e_a_d_m_e_autotoc_md10}
...
\begin{DoxyImage}
\includegraphics[width=\textwidth,height=\textheight/2,keepaspectratio=true]{shamir.jpg}
\doxyfigcaption{shamir}
\end{DoxyImage}
...
\begin{DoxyImage}
\includegraphics[width=\textwidth,height=\textheight/2,keepaspectratio=true]{lagrange.jpg}
\doxyfigcaption{lagrange}
\end{DoxyImage}
...
\begin{DoxyImage}
\includegraphics[width=\textwidth,height=\textheight/2,keepaspectratio=true]{lagrange_basis.jpg}
\doxyfigcaption{lagrange\+\_\+basis}
\end{DoxyImage}
  \hypertarget{md__r_e_a_d_m_e_autotoc_md12}{}\doxysubsection{Share Generation}\label{md__r_e_a_d_m_e_autotoc_md12}
\hypertarget{md__r_e_a_d_m_e_autotoc_md13}{}\doxysubsubsection{INPUT\+: secret $<$em$>$s$<$/em$>$, total number of shares $<$em$>$n$<$/em$>$, threshold $<$em$>$t$<$/em$>$, order of Galois field $<$em$>$q$<$/em$>$, irreducible polynomial of GF($<$em$>$q$<$/em$>$)}\label{md__r_e_a_d_m_e_autotoc_md13}
\hypertarget{md__r_e_a_d_m_e_autotoc_md14}{}\doxysubsubsection{OUTPUT\+: list of $<$em$>$n$<$/em$>$ shares}\label{md__r_e_a_d_m_e_autotoc_md14}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md15}{}\doxysubsection{Secret Reconstruction}\label{md__r_e_a_d_m_e_autotoc_md15}
\hypertarget{md__r_e_a_d_m_e_autotoc_md16}{}\doxysubsubsection{INPUT\+: list of share id $<$em$>$x$<$/em$>$, list of access shares $<$em$>$y$<$/em$>$, order of Galois field $<$em$>$q$<$/em$>$, irreducible polynomial of GF($<$em$>$q$<$/em$>$), digest length $<$em$>$d$<$/em$>$.}\label{md__r_e_a_d_m_e_autotoc_md16}
\hypertarget{md__r_e_a_d_m_e_autotoc_md17}{}\doxysubsubsection{OUTPUT\+: secret $<$em$>$s\textquotesingle{}$<$/em$>$ or abort.}\label{md__r_e_a_d_m_e_autotoc_md17}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md18}{}\doxysection{Basic usage}\label{md__r_e_a_d_m_e_autotoc_md18}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md19}{}\doxysection{Format of a share}\label{md__r_e_a_d_m_e_autotoc_md19}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md20}{}\doxysection{Design rationale}\label{md__r_e_a_d_m_e_autotoc_md20}
\hypertarget{md__r_e_a_d_m_e_autotoc_md21}{}\doxysubsection{Role of the digest}\label{md__r_e_a_d_m_e_autotoc_md21}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md22}{}\doxysubsection{Number of words and Galois field}\label{md__r_e_a_d_m_e_autotoc_md22}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md23}{}\doxysubsection{Security}\label{md__r_e_a_d_m_e_autotoc_md23}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md24}{}\doxysubsection{References}\label{md__r_e_a_d_m_e_autotoc_md24}
