\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md4}{}\doxysection{Table of contents}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md4}
...
\end{longtabu}
\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md7}{}\doxysection{Shamir secret sharing scheme}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md7}
Let F be a finite field with q elements. A $\ast$(t, n)-\/threshold secret sharing scheme$\ast$ shares a non-\/zero secret {\itshape s} among {\itshape n} users such that any {\itshape t} or more shares can reconstruct the secret but {\itshape t-\/1} or less cannot. Shamir\textquotesingle{}s secret sharing scheme is an ideal and perfect $\ast$(t, n)-\/thresholds scheme$\ast$ and can be defined in two phases as follows\+:\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md8}{}\doxysubsection{1. Share Generation Phase\+:}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md8}
...
\end{DoxyItemize}\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md9}{}\doxysubsection{2. Reconstruction Phase\+:}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md9}
...
Our scheme takes a secret mnemonic as string, converts it to binary string and performs padding if needed. Then it is converted to integer. After generating the integer shares, all the shares are converted into string and parsed as distinct n mnemonics. Below we describe only the share generation and secret reconstruction phases.\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md10}{}\doxysection{Generating shares and reconstruction of the secret}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md10}
\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md11}{}\doxysubsection{Polynomial interpolation}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md11}
...
\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md12}{}\doxysubsection{Share Generation}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md12}
\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md13}{}\doxysubsubsection{INPUT\+: secret $<$em$>$s$<$/em$>$, total number of shares $<$em$>$n$<$/em$>$, threshold $<$em$>$t$<$/em$>$, order of Galois field $<$em$>$q$<$/em$>$, irreducible polynomial of GF($<$em$>$q$<$/em$>$)}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md13}
\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md14}{}\doxysubsubsection{OUTPUT\+: list of $<$em$>$n$<$/em$>$ shares}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md14}
...
\end{DoxyItemize}\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md15}{}\doxysubsection{Secret Reconstruction}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md15}
\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md16}{}\doxysubsubsection{INPUT\+: list of share id $<$em$>$x$<$/em$>$, list of access shares $<$em$>$y$<$/em$>$, order of Galois field $<$em$>$q$<$/em$>$, irreducible polynomial of GF($<$em$>$q$<$/em$>$), digest length $<$em$>$d$<$/em$>$.}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md16}
\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md17}{}\doxysubsubsection{OUTPUT\+: secret $<$em$>$s\textquotesingle{}$<$/em$>$ or abort.}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md17}
...
\end{DoxyItemize}\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md18}{}\doxysection{Basic usage}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md18}
...
\end{DoxyItemize}\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md19}{}\doxysection{Format of a share}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md19}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md20}{}\doxysection{Design rationale}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md20}
\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md21}{}\doxysubsection{Role of the digest}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md21}
...
\end{DoxyItemize}\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md22}{}\doxysubsection{Number of words and Galois field}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md22}
...
\end{DoxyItemize}\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md23}{}\doxysubsection{Security}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md23}
...
\end{DoxyItemize}\hypertarget{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md24}{}\doxysubsection{References}\label{md__projects_research_mnemonic__r_e_a_d_m_e_autotoc_md24}
